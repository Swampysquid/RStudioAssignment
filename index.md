...
I support this discovery with the data visualizations I created. They will show the leading causes of death as a whole, and then broken down by age, sex, and race; I will also break down sex and race into different age brackets. When broken into these different demographics, it becomes clear that while heart disease is a major issue (it is still the leading cause of death after all), putting all Americans under the umbrella of heart disease being their biggest obstacle, may be a bit misleading.
...
Figure 2 was my first separation into a subgroup, and I chose to use the age group 65+. As I kind of expected, they followed the trend which figure 1 created, possessing 4 of the 5 leading causes of death overall (and the first 3 being in order too).
...
In conclusion, I did find an answer to my original curiosity: unintentional injury, and by proxy drug overdose, was the leading cause of death of Americans aged 1-45, and not heart disease. However I also discovered a lot more, by changing the scope of what the data looked at. By viewing the results not only by age group, but also by sex and race, I got to see a lot of information which would have otherwise been concealed if I only looked at it all as a whole. While it is true that heart disease is still the number one cause of death in America, we need to make sure that we still address the other issues, such as homicide as a leading cause of death in black people age 15-24, and not leave them out of the discussion. Ultimately, being able to subset data is very valuable, and can allow you to view data which would have otherwise been lost in the numbers.
